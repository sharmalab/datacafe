...
Include the auth details in the ${DRILL-HOME}/conf/drill-override.conf as below:
------------------------------------------------------------------------------------
drill.exec: {
   security.user.auth {
         enabled: true,
...
Configure ${DRILL-HOME}/conf/drill-env.sh to include the authentication information.
------------------------------------------------------------------------------------
