...
public class Executor {
    public static void main(String[] args) {
        ...
        List ids1 = MongoConnector.getID(database1, table1, document1);
        ...
        List ids2 = MongoConnector.getID(database2, table2, document2);

        // Interested Attributes: "patientID", "gender", "laterality"
        List chosenAttributes1 = MongoConnector.getAttributeValues(database1, table1, ids1, new String[]{"Gender", "Laterality"});

        // Interested Attributes: "sliceID", "patientID", "slideBarCode"
        List chosenAttributes2 = MongoConnector.getAttributeValues(database2, table2, ids2, new String[]{"BCR_Patient_UID_From_Pathology", "Slide_Barcode"});
