...
public class MongoHDFSIntegrator {
     ...
     */
    public static List[] getAllChosenAttributes(String[] databases, String[] collections,
                                                MongoConnector mongoConnector, List[] idsArray) {
     ...
     */
    public static List[] getListsOfIds(String[] databases, String[] collections, MongoConnector mongoConnector,
                                       Document[] documents) {
